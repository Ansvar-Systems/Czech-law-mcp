/**
 * Tool registry for Czech Law MCP Server.
...
import { getCzechImplementations, type GetCzechImplementationsInput } from './get-czech-implementations.js';
...
const LIST_SOURCES_TOOL: Tool = {
  ...
  description:
    ...
    'including the Sbírka zákonů (Collection of Laws) (Czech Government, Office of Parliamentary Counsel). ' +
...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    description:
      ...
      'Poland is not an EU member but Czech laws may reference EU directives/regulations ' +
    ...
    inputSchema: {
      type: 'object',
      properties: {
        document_id: { type: 'string', description: 'Czech statute identifier.' },
        include_articles: {
          type: 'boolean',
  ...
  {
    name: 'get_czech_implementations',
    description:
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        has_czech_implementation: {
          type: 'boolean',
          description: 'If true, only return EU documents referenced by Czech legislation.',
        },
    ...
    try {
      ...
      switch (name) {
        ...
        case 'get_eu_basis':
          ...
          break;
        case 'get_czech_implementations':
          result = await getCzechImplementations(db, args as unknown as GetCzechImplementationsInput);
          break;
