...
- **No Attorney-Client Relationship**: Use of this Tool does not create an attorney-client relationship (vztah advokát–klient / mandátní vztah)
...
This Tool aggregates data from official Czech legal databases. However:
...
- ASPI (Wolters Kluwer), Beck-online (C.H. Beck), CODEXIS (Atlas Consulting)

These services provide editorial oversight, comprehensive annotations (komentáře), and professional-grade currency guarantees that this Tool **cannot** provide.
...
- Even "fresh" data may be outdated if recent amendments were published in the Sbírka zákonů a mezinárodních smluv
- Staleness warnings do not guarantee completeness or accuracy
- Always check official sources for the current legal position (aktuální právní stav)
...
This disclaimer may be updated as the Tool evolves or legal/regulatory requirements change. Check the [GitHub repository](https://github.com/Ansvar-Systems/Czech-law-mcp) for the current version.

## Questions?

For questions about this disclaimer or the Tool's limitations, please open an issue on GitHub:
https://github.com/Ansvar-Systems/Czech-law-mcp/issues
